...
- [ShopSavvy Worker](https://github.com/shopsavvy/cloudflare-worker-shopsavvy) - Product data at the edge — real-time pricing, product search, and price history via a Cloudflare Worker.
