...
- [ShotOG](https://github.com/nicepkg/shotog) - Open-source OG image generation API powered by Workers. 8 templates, batch generation, custom fonts, edge-native ~50ms rendering.
