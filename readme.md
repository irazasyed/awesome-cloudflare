...
- [F1 API](https://github.com/AmiiGood/f1-api) - Free Formula 1 historical data API (1950–present) built on Workers + D1 + R2. Live at [f1api.sweetcode.app](https://f1api.sweetcode.app/docs).
