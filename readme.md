...
- [Nexus](https://nexus.keylightdigital.dev) - Observability platform for AI agents built on Cloudflare Workers + D1. Trace viewer, span timeline, cost tracking, and alerting. MIT license.
